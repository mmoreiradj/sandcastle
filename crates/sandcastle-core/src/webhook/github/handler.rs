...
declare_header!("x-github-event" => GithubEvent: serde Event);
...
pub async fn handle_webhook(
    ...
    println!("Event: {:?}", headers.event.0);
    println!("Hook ID: {}", headers.hook_id.0);
    println!("Installation Target ID: {}", headers.installation_target_id.0);
    println!("Installation Target Type: {}", headers.installation_target_type.0);
